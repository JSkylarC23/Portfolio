...
public class TargetPos6 : MonoBehaviour
{
    private double dub;
    public float var1;
    public float var;
    ...
    {
        TargetPos6 receiveObj = new TargetPos6();
        receiveObj.init();
    ...
    void Update()
    {
        ...
        //float angle = 180.0f - Vector3.Angle(refAxis.transform.forward, transform.forward);
        float angle = Vector3.SignedAngle(refAxis.transform.forward, transform.forward, transform.up);
