...
public class TargetPos1 : MonoBehaviour
{
    private double dub;
    public float var1;
    public float var;
    ...
    {
        TargetPos1 receiveObj = new TargetPos1();
        receiveObj.init();
    ...
    void Update()
    {
        ...
        //float angle = Vector3.Angle(origin, transform.forward) + 180.0f;
