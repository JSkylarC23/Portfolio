...
public class Axis4Rotate : MonoBehaviour
{
    public float angle;
    public Rigidbody rb;
    private double dub;
    ...
    // public
    // public string IP = "127.0.0.1"; default localb
    ...
    {
        Axis4Rotate receiveObj = new Axis4Rotate();
        receiveObj.init();
    ...
    void Update()
    {
        transform.Rotate(Vector3.up * var*2 * Time.deltaTime * angle, Space.Self);
    }
}